package com.example.asilapp10.QRCode.utils;
...
public class QRCode {
    public static void Generate(View view) {
        ImageView qrCodeImageView = view.findViewById(R.id.imageViewQRCode);

        // Generate QR Code
        String data = "MRTMTT91D08F205J";
